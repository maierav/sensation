...
This Jupyter book provides an open source, opinionated[^1], principled, and structured broad strokes introduction to the science of sensation and perception. If you are unsure whether this will be worth it or interesting: Think of the study of perception as a study of _yourself_ at the most profound deepest level; the starting point of finding out more about what you are (which, some argue, is the starting point of _all_ studies). On the flips side this means that teaching perception has an element of teaching about onself, which comes with the corollary that one should approach more than one teacher. Towards this aim, select scholarly references are provided for additional self-study[^2].  
