...
:::{note}
"Perception" is sometimes used as a replacement word for _opinions_. That is, we sometimes refer to different _thoughts_ on certain matters (such as political topics) as "views", "perspectives", or "perception".
