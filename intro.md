...
Importantly, what does not seem to follow from this development is that "Euclid was wrong", or that "geometry is arbitrary". Euclidian geoemetry still well explains the spatial domain of our daily lives. Just like Newtonian physics explains most of the physical phenomena, and most of our technology exceedingly well. Only on very small or large spatial scales do we find a mathematics and a physics that deviates (such as relativity and quantum physics). And for our perception, much of that classical geometry and physics is sufficient (though there are some exceptions that we will consider when appropriate).
