...
This Jupyter book provides an open source, opinionated[^1], principled, and structured broad strokes introduction to the science of sensation and perception. Written by a human with 10+ years of experience teching the topic and 20+ years of experience doing accredited research on the topic. Select scholarly references are provided for additional self-study[^2].  
