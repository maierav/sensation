...
[A minor point of potential confusion in the form of some amguity of sorts is the _notation_ that we learn with multiplication in that we use _a*b_, _$a\cdotb$_, and _ab_ alike.]
...
[Not making things any less confusin, the _notation_ of division can be confusing in that we use _a:b_, and _a/b_, and _$\frac{a}{b}$_ alike.]
